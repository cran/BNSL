...
aster_cpp <- function(matrix, tree_width = 0L, proc = 1L) {
    .Call('BNSL_aster_cpp', PACKAGE = 'BNSL', matrix, tree_width, proc)
}
...
Bayes_score <- function(T, m, proc = 1L) {
    .Call('BNSL_Bayes_score', PACKAGE = 'BNSL', T, m, proc)
}

bound <- function(T, m, proc = 1L) {
    .Call('BNSL_bound', PACKAGE = 'BNSL', T, m, proc)
}
...
BDeu_score <- function(T, m) {
    .Call('BNSL_BDeu_score', PACKAGE = 'BNSL', T, m)
}

MDL_score <- function(T, m) {
    .Call('BNSL_MDL_score', PACKAGE = 'BNSL', T, m)
}
...
MDL_bound <- function(T, m) {
    .Call('BNSL_MDL_bound', PACKAGE = 'BNSL', T, m)
}
